...
object olivia {
	...
	method gradoDeConcentracion() = concentracion.max(6)
	method recibirMasajes(){concentracion = concentracion +3}
	method discutir(){concentracion --}
...
object ramiro {
	...
	method nivelContractura() = nivelContractura.max(0)
	...
	method bajarALaFosa() {pielGrasosa = true; nivelContractura += 1}
	method jugarAlPaddle() {nivelContractura += 3}
